...
use App\Interfaces\Parseable;
use App\Traits\ParseByType;
use Eloquent;
...
class InfistarLog extends Model
{
     ...
     * @return Collection
     */
    public function retrieveData(string $logName): Collection
    {
        return self::whereLogname($logName)->whereParsed(false)->get();
    }

    public function getLogEntryColumn(): string
    {
        return 'logentry';
    }
}
