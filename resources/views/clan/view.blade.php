...
@section('content')
    ...
    @if($territories)
        <h1 class="text-sg-red my-8 text-center text-3xl">Territory Information of {{ $clan->name }} - In Total Member of {{ $territories->count() > 1 ? $territories->count(). 'Territories' : '1 Territory' }} </h1>
        <div class="w-3/4 grid grid-cols-3 gap-8 mx-auto">
