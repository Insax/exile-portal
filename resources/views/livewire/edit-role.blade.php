<div>
    <form wire:submit.prevent="update">
        <div
            class="bg-portal-gray modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-clip-padding rounded-md outline-none text-current container-portal">
            <div
                        ...
                        @foreach($this->permissions as $permission)
                            <label class="items-center text-sm block" for="{{$permission->name}}">
                                <input type="checkbox" name="remember" id="remember"
                                       class="form-checkbox h-5 w-5 bg-portal-gray checked:bg-portal-gray text-portal-red"
            ...
            <div
                class="modal-footer flex flex-shrink-0 flex-wrap items-center justify-end p-4 border-t rounded-b-md card-portal">
