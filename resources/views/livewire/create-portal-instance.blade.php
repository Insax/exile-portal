<div>
    <!-- Modal -->
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto card-portal"
         id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
         aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="wire:ignore.self modal-dialog relative w-auto pointer-events-none card-portal">
            <form wire:submit.prevent="store">
                <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-clip-padding rounded-md outline-none text-current card-portal">
                    <div
                    ...
                    <div class="modal-footer flex flex-shrink-0 flex-wrap items-center justify-end p-4 border-t rounded-b-md card-portal">
                        <button type="button" class="btn-portal inline-block px-6 py-2.5 font-medium text-xs leading-tight uppercase rounded shadow-md transition duration-150 ease-in-out" data-bs-dismiss="modal">Close</button>
    ...
    <section class="w-full flex flex-col break-words card-portal sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg mt-4">
                    ...
                    <div class="flex items-center items-stretch w-full">
                            <div class="flex flex-wrap items-stretch w-full mb-4 relative">
                                <div class="flex -mr-px">
                                    <span class="card-header-portal flex items-center leading-normal rounded rounded-r-none border border-r-0 px-3 whitespace-no-wrap text-sm"> {{ $instance->name }}</span>
                                </div>
