...
@section('content')
    ...
    <h1 class="text-sg-red my-8 text-center text-5xl">Player Information</h1>
    <div class="w-3/4 grid grid-cols-3 gap-8 mx-auto">
        ...
        <div class="card-header-sg p-6 rounded-2xl shadow-lg text-center">
            ...
            <p>
                <button class="btn-sg mb-6 w-full select-none font-bold whitespace-no-wrap p-3 rounded-lg text-base leading-normal no-underline btn-sg sm:py-4 text-sg-gray">Reset Exp</button>
            </p>
        </div>
        <div class="card-header-sg p-6 rounded-2xl shadow-lg text-center">
    ...
    @if($territories)
        <h1 class="text-sg-red my-8 text-center text-3xl">Territory Information - Member of {{ $territories->count() > 1 ? $territories->count(). 'Territories' : '1 Territory' }} </h1>
        <div class="w-3/4 grid grid-cols-3 gap-8 mx-auto">
